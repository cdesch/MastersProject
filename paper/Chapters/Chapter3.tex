...
Afterward the children were allowed to play with a visualizer\footnote{The visualizer 3d rendering of what the LeapMotion detects} of the LeapMotion at the end of the session. 
