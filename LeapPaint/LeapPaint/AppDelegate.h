...
@property (strong) IBOutlet NSWindow *window;/**< window is the main window to be displayed */
@property (strong) IBOutlet CCGLView *glView;/**< glView is the embedded view in which cocos2d will run inside the window */
