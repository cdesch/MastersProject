...
Definition at line 27 of file Game\-Manager.\-h.
...
Definition at line 328 of file Game\-Manager.\-mm.


\begin{DoxyCode}
328                           :(float)value\{
329     \textcolor{comment}{//NSLog(@"value %0.0f", value);}
330     \textcolor{keywordflow}{if} (value < kOpMinRange)\{
331         \textcolor{keywordflow}{return} kOpMax;
332     \}\textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(value > kOpMaxRange)\{
333         \textcolor{keywordflow}{return} kOpMin;
334     \}\textcolor{keywordflow}{else} \{
335         
336         \textcolor{keywordtype}{float} percentage = [\textcolor{keyword}{self} findPecentageDifference:kOpMaxRange withMin:kOpMinRange withValue:value];
337         \textcolor{comment}{//NSLog(@"percentage %0.0f", percentage);}
338         
339         percentage = 100 - percentage;
340         
341         \textcolor{keywordflow}{return} percentage;
342         
343     \}
344 
345 \}
...
Definition at line 41 of file Game\-Manager.\-h.
...
Definition at line 39 of file Game\-Manager.\-h.
...
Definition at line 49 of file Game\-Manager.\-h.
